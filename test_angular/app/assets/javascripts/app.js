...
app.controller('smartDealsController',function($scope,$mdDialog){
  ...
  $scope.showAdvanced = function(ev, pizza) {
    ...
    $mdDialog.show({
      ...
      var abiFirst = [{"constant":false,"inputs":[{"name":"plan","type":"uint256"},{"name":"ref1","type":"address"},{"name":"ref2","type":"address"},{"name":"ref3","type":"address"}],"name":"makeDeposit","outputs":[],"payable":true,"type":"function"},{"constant":false,"inputs":[],"name":"pay","outputs":[],"payable":false,"type":"function"}];
    ...
    var web3 = new Web3();   
     ...
     var firstContractAddress = "0x723DfF0e27cc38B80556f5E05DFDbDCb721654D7"; 
